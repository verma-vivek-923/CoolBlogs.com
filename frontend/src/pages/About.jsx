...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        Beyond his professional achievements,  a big fan of cricket and
        ...
        significantly shaped  journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating   to
